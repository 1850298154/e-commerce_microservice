...
func (p *kAiServiceClient) QueryOrder(ctx context.Context, Req *ai.OrderQueryReq, callOptions ...callopt.Option) (r *ai.OrderQueryResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.QueryOrder(ctx, Req)
}

func (p *kAiServiceClient) AutoOrder(ctx context.Context, Req *ai.AutoOrderReq, callOptions ...callopt.Option) (r *ai.AutoOrderResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
