...
func (p *kAuthServiceClient) SearchforOrder(ctx context.Context, Req *ai.SearchforOrderReq, callOptions ...callopt.Option) (r *ai.SearchforOrderResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.SearchforOrder(ctx, Req)
}
