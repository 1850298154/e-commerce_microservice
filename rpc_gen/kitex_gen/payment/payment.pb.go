...
type TimedCancelPaymentReq struct {
	...
	TransactionId string `protobuf:"bytes,1,opt,name=transaction_id,json=transactionId,proto3" json:"transaction_id,omitempty"`
	UserId        uint32 `protobuf:"varint,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	CancelTime    int32  `protobuf:"varint,3,opt,name=cancel_time,json=cancelTime,proto3" json:"cancel_time,omitempty"`
}

func (x *TimedCancelPaymentReq) Reset() {
	*x = TimedCancelPaymentReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *TimedCancelPaymentReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TimedCancelPaymentReq) ProtoMessage() {}

func (x *TimedCancelPaymentReq) ProtoReflect() protoreflect.Message {
	mi := &file_payment_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TimedCancelPaymentReq.ProtoReflect.Descriptor instead.
func (*TimedCancelPaymentReq) Descriptor() ([]byte, []int) {
	return file_payment_proto_rawDescGZIP(), []int{5}
}

func (x *TimedCancelPaymentReq) GetTransactionId() string {
	if x != nil {
		return x.TransactionId
	}
	return ""
...
func (x *TimedCancelPaymentReq) GetUserId() uint32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *TimedCancelPaymentReq) GetCancelTime() int32 {
	if x != nil {
		return x.CancelTime
	}
	return 0
...
func (x *TimedCancelPaymentResp) Reset() {
	*x = TimedCancelPaymentResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *TimedCancelPaymentResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TimedCancelPaymentResp) ProtoMessage() {}

func (x *TimedCancelPaymentResp) ProtoReflect() protoreflect.Message {
	mi := &file_payment_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TimedCancelPaymentResp.ProtoReflect.Descriptor instead.
func (*TimedCancelPaymentResp) Descriptor() ([]byte, []int) {
	return file_payment_proto_rawDescGZIP(), []int{6}
}

func (x *TimedCancelPaymentResp) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
var file_payment_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0x52, 0x0a, 0x10, 0x43, 0x61,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x2d,
	0x0a, 0x11, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x52,
	...
	0x15, 0x54, 0x69, 0x6d, 0x65, 0x64, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x50, 0x61, 0x79, 0x6d,
	0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x12, 0x25, 0x0a, 0x0e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61,
	...
	0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c,
	0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x63, 0x61, 0x6e,
	0x63, 0x65, 0x6c, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x32, 0x0a, 0x16, 0x54, 0x69, 0x6d, 0x65, 0x64,
	...
	,
...
var file_payment_proto_goTypes = []interface{}{
	...
	(*TimedCancelPaymentReq)(nil),  // 5: payment.TimedCancelPaymentReq
	(*TimedCancelPaymentResp)(nil), // 6: payment.TimedCancelPaymentResp
}
var file_payment_proto_depIdxs = []int32{
	...
	5, // 3: payment.PaymentService.TimedCancelPayment:input_type -> payment.TimedCancelPaymentReq
	...
	6, // 6: payment.PaymentService.TimedCancelPayment:output_type -> payment.TimedCancelPaymentResp
...
func file_payment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_payment_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TimedCancelPaymentReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_payment_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TimedCancelPaymentResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type PaymentService interface {
	...
	TimedCancelPayment(ctx context.Context, req *TimedCancelPaymentReq) (res *TimedCancelPaymentResp, err error)
}
