...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"TimedCancelPayment": kitex.NewMethodInfo(
		...
		newTimedCancelPaymentArgs,
		newTimedCancelPaymentResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingUnary),
	),
}
...
func timedCancelPaymentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(payment.TimedCancelPaymentReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(payment.PaymentService).TimedCancelPayment(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *TimedCancelPaymentArgs:
		success, err := handler.(payment.PaymentService).TimedCancelPayment(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*TimedCancelPaymentResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newTimedCancelPaymentArgs() interface{} {
	return &TimedCancelPaymentArgs{}
}

func newTimedCancelPaymentResult() interface{} {
	return &TimedCancelPaymentResult{}
}

type TimedCancelPaymentArgs struct {
	Req *payment.TimedCancelPaymentReq
}

func (p *TimedCancelPaymentArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(payment.TimedCancelPaymentReq)
	}
	return p.Req.FastRead(buf, _type, number)
}

func (p *TimedCancelPaymentArgs) FastWrite(buf []byte) (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.FastWrite(buf)
...
func (p *TimedCancelPaymentArgs) Size() (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.Size()
...
func (p *TimedCancelPaymentArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *TimedCancelPaymentArgs) Unmarshal(in []byte) error {
	msg := new(payment.TimedCancelPaymentReq)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var TimedCancelPaymentArgs_Req_DEFAULT *payment.TimedCancelPaymentReq

func (p *TimedCancelPaymentArgs) GetReq() *payment.TimedCancelPaymentReq {
	if !p.IsSetReq() {
		return TimedCancelPaymentArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *TimedCancelPaymentArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *TimedCancelPaymentArgs) GetFirstArgument() interface{} {
	return p.Req
}

type TimedCancelPaymentResult struct {
	Success *payment.TimedCancelPaymentResp
}

var TimedCancelPaymentResult_Success_DEFAULT *payment.TimedCancelPaymentResp

func (p *TimedCancelPaymentResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(payment.TimedCancelPaymentResp)
	}
	return p.Success.FastRead(buf, _type, number)
}

func (p *TimedCancelPaymentResult) FastWrite(buf []byte) (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.FastWrite(buf)
...
func (p *TimedCancelPaymentResult) Size() (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.Size()
...
func (p *TimedCancelPaymentResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *TimedCancelPaymentResult) Unmarshal(in []byte) error {
	msg := new(payment.TimedCancelPaymentResp)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *TimedCancelPaymentResult) GetSuccess() *payment.TimedCancelPaymentResp {
	if !p.IsSetSuccess() {
		return TimedCancelPaymentResult_Success_DEFAULT
	}
	return p.Success
}

func (p *TimedCancelPaymentResult) SetSuccess(x interface{}) {
	p.Success = x.(*payment.TimedCancelPaymentResp)
}

func (p *TimedCancelPaymentResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *TimedCancelPaymentResult) GetResult() interface{} {
	return p.Success
}
...
func (p *kClient) TimedCancelPayment(ctx context.Context, Req *payment.TimedCancelPaymentReq) (r *payment.TimedCancelPaymentResp, err error) {
	var _args TimedCancelPaymentArgs
	_args.Req = Req
	var _result TimedCancelPaymentResult
