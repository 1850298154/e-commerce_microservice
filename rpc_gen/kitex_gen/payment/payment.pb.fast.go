...
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_CreditCardInfo[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_ChargeReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_ChargeResp[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_CancelPaymentReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_CancelPaymentResp[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_TimedCancelPaymentReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_TimedCancelPaymentResp[number], err)
}
