...
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' apiErr: %s", x, number, fieldIDToName_CreditCardInfo[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, apiErr: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' apiErr: %s", x, number, fieldIDToName_ChargeReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, apiErr: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' apiErr: %s", x, number, fieldIDToName_ChargeResp[number], err)
}
...
func (x *CancelPaymentReq) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, apiErr: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' apiErr: %s", x, number, fieldIDToName_CancelPaymentReq[number], err)
}

func (x *CancelPaymentReq) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.TransactionId, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *CancelPaymentReq) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.UserId, offset, err = fastpb.ReadUint32(buf, _type)
	return offset, err
}

func (x *CancelPaymentResp) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, apiErr: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' apiErr: %s", x, number, fieldIDToName_CancelPaymentResp[number], err)
}

func (x *CancelPaymentResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.Success, offset, err = fastpb.ReadBool(buf, _type)
	return offset, err
}

func (x *TimedCancelPaymentReq) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, apiErr: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' apiErr: %s", x, number, fieldIDToName_TimedCancelPaymentReq[number], err)
}

func (x *TimedCancelPaymentReq) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.TransactionId, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *TimedCancelPaymentReq) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.UserId, offset, err = fastpb.ReadUint32(buf, _type)
	return offset, err
}

func (x *TimedCancelPaymentReq) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	x.CancelTime, offset, err = fastpb.ReadInt32(buf, _type)
	return offset, err
}

func (x *TimedCancelPaymentResp) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, apiErr: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' apiErr: %s", x, number, fieldIDToName_TimedCancelPaymentResp[number], err)
}

func (x *TimedCancelPaymentResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.Success, offset, err = fastpb.ReadBool(buf, _type)
	return offset, err
}
...
func (x *CancelPaymentReq) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *CancelPaymentReq) fastWriteField1(buf []byte) (offset int) {
	if x.TransactionId == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 1, x.GetTransactionId())
...
func (x *CancelPaymentReq) fastWriteField2(buf []byte) (offset int) {
	if x.UserId == 0 {
		return offset
	}
...
func (x *CancelPaymentResp) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *CancelPaymentResp) fastWriteField1(buf []byte) (offset int) {
	if !x.Success {
		return offset
	}
...
func (x *TimedCancelPaymentReq) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *TimedCancelPaymentReq) fastWriteField1(buf []byte) (offset int) {
	if x.TransactionId == "" {
		return offset
	}
	offset += fastpb.WriteString(buf[offset:], 1, x.GetTransactionId())
...
func (x *TimedCancelPaymentReq) fastWriteField2(buf []byte) (offset int) {
	if x.UserId == 0 {
		return offset
	}
	offset += fastpb.WriteUint32(buf[offset:], 2, x.GetUserId())
...
func (x *TimedCancelPaymentReq) fastWriteField3(buf []byte) (offset int) {
	if x.CancelTime == 0 {
		return offset
	}
	offset += fastpb.WriteInt32(buf[offset:], 3, x.GetCancelTime())
	return offset
}

func (x *TimedCancelPaymentResp) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *TimedCancelPaymentResp) fastWriteField1(buf []byte) (offset int) {
	if !x.Success {
		return offset
	}
	offset += fastpb.WriteBool(buf[offset:], 1, x.GetSuccess())
...
func (x *CancelPaymentReq) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *CancelPaymentReq) sizeField1() (n int) {
	if x.TransactionId == "" {
		return n
	}
	n += fastpb.SizeString(1, x.GetTransactionId())
...
func (x *CancelPaymentReq) sizeField2() (n int) {
	if x.UserId == 0 {
		return n
	}
...
func (x *CancelPaymentResp) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *CancelPaymentResp) sizeField1() (n int) {
	if !x.Success {
		return n
	}
...
func (x *TimedCancelPaymentReq) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *TimedCancelPaymentReq) sizeField1() (n int) {
	if x.TransactionId == "" {
		return n
	}
	n += fastpb.SizeString(1, x.GetTransactionId())
...
func (x *TimedCancelPaymentReq) sizeField2() (n int) {
	if x.UserId == 0 {
		return n
	}
	n += fastpb.SizeUint32(2, x.GetUserId())
...
func (x *TimedCancelPaymentReq) sizeField3() (n int) {
	if x.CancelTime == 0 {
		return n
	}
	n += fastpb.SizeInt32(3, x.GetCancelTime())
	return n
}

func (x *TimedCancelPaymentResp) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *TimedCancelPaymentResp) sizeField1() (n int) {
	if !x.Success {
		return n
	}
	n += fastpb.SizeBool(1, x.GetSuccess())
...
var fieldIDToName_CancelPaymentReq = map[int32]string{
	1: "TransactionId",
	2: "UserId",
}
...
var fieldIDToName_TimedCancelPaymentReq = map[int32]string{
	1: "TransactionId",
	2: "UserId",
	3: "CancelTime",
}

var fieldIDToName_TimedCancelPaymentResp = map[int32]string{
	1: "Success",
}
