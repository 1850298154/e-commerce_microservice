...
type RenewTokenByRPCResult struct {
	Success *auth.RenewTokenResp
}

var RenewTokenByRPCResult_Success_DEFAULT *auth.RenewTokenResp

func (p *RenewTokenByRPCResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(auth.RenewTokenResp)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *RenewTokenByRPCResult) GetSuccess() *auth.RenewTokenResp {
	if !p.IsSetSuccess() {
...
func (p *RenewTokenByRPCResult) SetSuccess(x interface{}) {
	p.Success = x.(*auth.RenewTokenResp)
}
...
var DeleteTokenByRPCResult_Success_DEFAULT *auth.DeleteTokenResp
...
func (p *DeleteTokenByRPCResult) GetSuccess() *auth.DeleteTokenResp {
	if !p.IsSetSuccess() {
...
func (p *kClient) DeleteTokenByRPC(ctx context.Context, Req *auth.DeleteTokenReq) (r *auth.DeleteTokenResp, err error) {
