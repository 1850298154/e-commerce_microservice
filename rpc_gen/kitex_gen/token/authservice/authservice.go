...
func newServiceInfo(hasStreaming bool, keepStreamingMethods bool, keepNonStreamingMethods bool) *kitex.ServiceInfo {
	...
	handlerType := (*token.AuthService)(nil)
...
func deliverTokenByRPCHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(token.DeliverTokenReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(token.AuthService).DeliverTokenByRPC(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *DeliverTokenByRPCArgs:
		success, err := handler.(token.AuthService).DeliverTokenByRPC(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *DeliverTokenByRPCArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(token.DeliverTokenReq)
	}
...
var DeliverTokenByRPCArgs_Req_DEFAULT *token.DeliverTokenReq

func (p *DeliverTokenByRPCArgs) GetReq() *token.DeliverTokenReq {
	if !p.IsSetReq() {
...
type DeliverTokenByRPCResult struct {
	Success *token.DeliveryResp
}

var DeliverTokenByRPCResult_Success_DEFAULT *token.DeliveryResp

func (p *DeliverTokenByRPCResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(token.DeliveryResp)
	}
...
func (p *DeliverTokenByRPCResult) GetSuccess() *token.DeliveryResp {
	if !p.IsSetSuccess() {
...
func (p *DeliverTokenByRPCResult) SetSuccess(x interface{}) {
	p.Success = x.(*token.DeliveryResp)
}
...
func verifyTokenByRPCHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(token.VerifyTokenReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(token.AuthService).VerifyTokenByRPC(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *VerifyTokenByRPCArgs:
		success, err := handler.(token.AuthService).VerifyTokenByRPC(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *VerifyTokenByRPCArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(token.VerifyTokenReq)
	}
	return p.Req.FastRead(buf, _type, number)
}
...
var VerifyTokenByRPCArgs_Req_DEFAULT *token.VerifyTokenReq

func (p *VerifyTokenByRPCArgs) GetReq() *token.VerifyTokenReq {
	if !p.IsSetReq() {
...
type VerifyTokenByRPCResult struct {
	Success *token.VerifyResp
}

var VerifyTokenByRPCResult_Success_DEFAULT *token.VerifyResp

func (p *VerifyTokenByRPCResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(token.VerifyResp)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *VerifyTokenByRPCResult) GetSuccess() *token.VerifyResp {
	if !p.IsSetSuccess() {
...
func renewTokenByRPCHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(token.RenewTokenReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(token.AuthService).RenewTokenByRPC(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *RenewTokenByRPCArgs:
		success, err := handler.(token.AuthService).RenewTokenByRPC(ctx, s.Req)
		if err != nil {
			return err
		}
...
var RenewTokenByRPCArgs_Req_DEFAULT *token.RenewTokenReq

func (p *RenewTokenByRPCArgs) GetReq() *token.RenewTokenReq {
	if !p.IsSetReq() {
...
type RenewTokenByRPCResult struct {
	Success *token.RenewTokenResp
}

var RenewTokenByRPCResult_Success_DEFAULT *token.RenewTokenResp

func (p *RenewTokenByRPCResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(token.RenewTokenResp)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *RenewTokenByRPCResult) GetSuccess() *token.RenewTokenResp {
	if !p.IsSetSuccess() {
...
func (p *RenewTokenByRPCResult) SetSuccess(x interface{}) {
	p.Success = x.(*token.RenewTokenResp)
}
...
func deleteTokenByRPCHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(token.DeleteTokenReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(token.AuthService).DeleteTokenByRPC(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *DeleteTokenByRPCArgs:
		success, err := handler.(token.AuthService).DeleteTokenByRPC(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *DeleteTokenByRPCArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(token.DeleteTokenReq)
	}
	return p.Req.FastRead(buf, _type, number)
}
...
var DeleteTokenByRPCArgs_Req_DEFAULT *token.DeleteTokenReq

func (p *DeleteTokenByRPCArgs) GetReq() *token.DeleteTokenReq {
	if !p.IsSetReq() {
...
type DeleteTokenByRPCResult struct {
	Success *token.DeleteTokenResp
}

var DeleteTokenByRPCResult_Success_DEFAULT *token.DeleteTokenResp

func (p *DeleteTokenByRPCResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(token.DeleteTokenResp)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *DeleteTokenByRPCResult) GetSuccess() *token.DeleteTokenResp {
	if !p.IsSetSuccess() {
...
func (p *DeleteTokenByRPCResult) SetSuccess(x interface{}) {
	p.Success = x.(*token.DeleteTokenResp)
}
...
func (p *kClient) DeliverTokenByRPC(ctx context.Context, Req *token.DeliverTokenReq) (r *token.DeliveryResp, err error) {
...
func (p *kClient) VerifyTokenByRPC(ctx context.Context, Req *token.VerifyTokenReq) (r *token.VerifyResp, err error) {
...
func (p *kClient) RenewTokenByRPC(ctx context.Context, Req *token.RenewTokenReq) (r *token.RenewTokenResp, err error) {
...
func (p *kClient) DeleteTokenByRPC(ctx context.Context, Req *token.DeleteTokenReq) (r *token.DeleteTokenResp, err error) {
