...
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_Address[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_PlaceOrderReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_OrderItem[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_OrderResult[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_PlaceOrderResp[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_ListOrderReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_Order[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_ListOrderResp[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_UpdateOrderReq[number], err)
}
...
func (x *UpdateOrderReq) fastReadField4(buf []byte, _type int8) (offset int, err error) {
	...
	x.NewOrderItems = append(x.NewOrderItems, &v)
	return offset, nil
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_UpdateOrderResp[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_CancelOrderReq[number], err)
}
...
func (x *CancelOrderReq) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.UserId, offset, err = fastpb.ReadUint32(buf, _type)
	return offset, err
}

func (x *CancelOrderReq) fastReadField3(buf []byte, _type int8) (offset int, err error) {
	x.TimedCancel, offset, err = fastpb.ReadBool(buf, _type)
	return offset, err
}

func (x *CancelOrderReq) fastReadField4(buf []byte, _type int8) (offset int, err error) {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_CancelOrderResp[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_MarkOrderPaidReq[number], err)
}
...
func (x *UpdateOrderReq) fastWriteField3(buf []byte) (offset int) {
	...
	offset += fastpb.WriteMessage(buf[offset:], 3, x.GetNewAddress())
	return offset
}

func (x *UpdateOrderReq) fastWriteField4(buf []byte) (offset int) {
	if x.NewOrderItems == nil {
		return offset
	}
	for i := range x.GetNewOrderItems() {
		offset += fastpb.WriteMessage(buf[offset:], 4, x.GetNewOrderItems()[i])
	}
	return offset
}
...
func (x *UpdateOrderReq) fastWriteField5(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 5, x.GetNewEmail())
	return offset
}
...
func (x *CancelOrderReq) fastWriteField2(buf []byte) (offset int) {
	if x.UserId == 0 {
		return offset
	}
	offset += fastpb.WriteUint32(buf[offset:], 2, x.GetUserId())
...
func (x *CancelOrderReq) fastWriteField3(buf []byte) (offset int) {
	if !x.TimedCancel {
		return offset
	}
	offset += fastpb.WriteBool(buf[offset:], 3, x.GetTimedCancel())
	return offset
}

func (x *CancelOrderReq) fastWriteField4(buf []byte) (offset int) {
	if x.CancelTime == 0 {
		return offset
	}
	offset += fastpb.WriteInt32(buf[offset:], 4, x.GetCancelTime())
	return offset
}
...
func (x *UpdateOrderReq) sizeField3() (n int) {
	...
	n += fastpb.SizeMessage(3, x.GetNewAddress())
	return n
}
...
func (x *UpdateOrderReq) sizeField4() (n int) {
	...
	for i := range x.GetNewOrderItems() {
		n += fastpb.SizeMessage(4, x.GetNewOrderItems()[i])
	}
	return n
}
...
func (x *UpdateOrderReq) sizeField5() (n int) {
	...
	n += fastpb.SizeString(5, x.GetNewEmail())
	return n
}
...
func (x *CancelOrderReq) sizeField2() (n int) {
	if x.UserId == 0 {
		return n
	}
	n += fastpb.SizeUint32(2, x.GetUserId())
...
func (x *CancelOrderReq) sizeField3() (n int) {
	if !x.TimedCancel {
		return n
	}
	n += fastpb.SizeBool(3, x.GetTimedCancel())
	return n
}

func (x *CancelOrderReq) sizeField4() (n int) {
	if x.CancelTime == 0 {
		return n
	}
	n += fastpb.SizeInt32(4, x.GetCancelTime())
	return n
}
