...
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_RegisterReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_RegisterResp[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_LoginReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_LoginResp[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_LogoutReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_LogoutResp[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_DeleteUserReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_DeleteUserResp[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_UpdateUserReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_UpdateUserResp[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_GetUserInfoReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_GetUserInfoResp[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_UpdateUserRoleReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_UpdateUserRoleResp[number], err)
}

func (x *UpdateUserRoleResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.Success, offset, err = fastpb.ReadBool(buf, _type)
	return offset, err
}
...
func (x *UpdateUserRoleResp) fastWriteField1(buf []byte) (offset int) {
	if !x.Success {
		return offset
	}
	offset += fastpb.WriteBool(buf[offset:], 1, x.GetSuccess())
...
func (x *UpdateUserRoleResp) sizeField1() (n int) {
	if !x.Success {
		return n
	}
	n += fastpb.SizeBool(1, x.GetSuccess())
