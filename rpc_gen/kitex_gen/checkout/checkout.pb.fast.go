...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_CheckoutReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_CheckoutResp[number], err)
}
