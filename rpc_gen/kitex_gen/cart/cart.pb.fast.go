...
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_CartItem[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_AddItemReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_EmptyCartReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_GetCartReq[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_GetCartResp[number], err)
}
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, errno: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' errno: %s", x, number, fieldIDToName_Cart[number], err)
}
