...
func (c *clientImpl) SearchProductsByName(ctx context.Context, Req *product.SearchProductsByNameReq, callOptions ...callopt.Option) (r *product.SearchProductsResp, err error) {
