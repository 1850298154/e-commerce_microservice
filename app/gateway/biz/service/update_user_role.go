...
func NewUpdateUserRoleService(ctx context.Context, requestContext *app.RequestContext) *UpdateUserRoleService {
	return &UpdateUserRoleService{RequestContext: requestContext, Context: ctx}
}
